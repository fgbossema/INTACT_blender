...
class INTACT_OT_JoinObjects(bpy.types.Operator):
    " Join Objects "

    bl_idname = "intact.join_objects"
    bl_label = "JOIN :"
...
class INTACT_OT_SeparateObjects(bpy.types.Operator):
    " Separate Objects "

    bl_idname = "intact.separate_objects"
    bl_label = "SEPARATE :"
...
class INTACT_OT_Parent(bpy.types.Operator):
    " Parent Object "

    bl_idname = "intact.parent_object"
    bl_label = "PARENT"
...
class INTACT_OT_Unparent(bpy.types.Operator):
    " Un-Parent objects"

    bl_idname = "intact.unparent_objects"
    bl_label = "Un-Parent"
...
class INTACT_OT_align_to_front(bpy.types.Operator):
    """Align Model To Front view"""

    bl_idname = "intact.align_to_front"
...
class INTACT_OT_to_center(bpy.types.Operator):
    " Center Model to world origin "

    bl_idname = "intact.to_center"
    bl_label = "TO CENTER"
...
class INTACT_OT_center_cursor(bpy.types.Operator):
    """Cursor to World Origin """

    bl_idname = "intact.center_cursor"
...
#######################################################################################
# Add Occlusal Plane :
class INTACT_OT_OcclusalPlane(bpy.types.Operator):
    """ Add Occlusal Plane"""

    bl_idname = "intact.occlusalplane"
...
############################################################################
class INTACT_OT_OcclusalPlaneInfo(bpy.types.Operator):
    """ Add Align Refference points """

    bl_idname = "intact.occlusalplaneinfo"
    bl_label = "INFO"
    bl_options = {"REGISTER", "UNDO"}
...
class INTACT_OT_decimate(bpy.types.Operator):
    """ Decimate to ratio """

    bl_idname = "intact.decimate"
    bl_label = "Decimate Model"
    bl_options = {"REGISTER", "UNDO"}

    def execute(self, context):
        INTACT_Props = context.scene.INTACT_Props
        decimate_ratio = round(INTACT_Props.decimate_ratio, 2)
...
class INTACT_OT_fill(bpy.types.Operator):
    """fill edge or face """

    bl_idname = "intact.fill"
    bl_label = "FILL"
    bl_options = {"REGISTER", "UNDO"}
...
class INTACT_OT_retopo_smooth(bpy.types.Operator):
    """Retopo sculpt for filled holes"""

    bl_idname = "intact.retopo_smooth"
...
class INTACT_OT_clean_mesh(bpy.types.Operator):
    """ Fill small and medium holes and remove small parts"""

    bl_idname = "intact.clean_mesh"
    bl_label = "CLEAN MESH"
    bl_options = {"REGISTER", "UNDO"}
...
class INTACT_OT_VoxelRemesh(bpy.types.Operator):
    """ Voxel Remesh Operator """

    bl_idname = "intact.voxelremesh"
    bl_label = "REMESH"
    bl_options = {"REGISTER", "UNDO"}
...
#######################################################################################
# CurveCutter_01
class INTACT_OT_CurveCutterAdd(bpy.types.Operator):
    """ description of this Operator """

    bl_idname = "intact.curvecutteradd"
    ...
    def modal(self, context, event):
        ...
        if not event.type in {
            ...
            if event.value == ("PRESS"):
                CurveCutterName = bpy.context.scene.INTACT_Props.CurveCutterNameProp
            ...
            if event.value == ("PRESS"):
                ...
                CuttingTargetName = context.scene.INTACT_Props.CuttingTargetNameProp
    ...
    def invoke(self, context, event):
        ...
        if bpy.context.selected_objects == []:
            ...
            if context.space_data.type == "VIEW_3D":
                ...
                bpy.context.scene.INTACT_Props.CuttingTargetNameProp = (
                    CuttingTarget.name
                )
...
class INTACT_OT_CurveCutterCut(bpy.types.Operator):
    " Performe Curve Cutting Operation"

    bl_idname = "intact.curvecuttercut"
    bl_label = "CURVE CUTTER CUT"

    def execute(self, context):

        # Get CuttingTarget :
        CuttingTargetName = bpy.context.scene.INTACT_Props.CuttingTargetNameProp
        CuttingTarget = bpy.data.objects[CuttingTargetName]
        ...
        CurveCuttersList = [
            ...
            if obj.type == "CURVE" and obj.name.startswith("INTACT_CuttingCurve")
        ]
        CurveMeshesList = []
...
#######################################################################################
# CurveCutter_02
class INTACT_OT_CurveCutterAdd2(bpy.types.Operator):
    """ description of this Operator """

    bl_idname = "intact.curvecutteradd2"
    bl_label = "CURVE CUTTER ADD"
    bl_options = {"REGISTER", "UNDO"}
...
class INTACT_OT_CurveCutter2_ShortPath(bpy.types.Operator):
    " Shortpath Curve Cutting tool"

    bl_idname = "intact.curvecutter2_shortpath"
    bl_label = "ShortPath"
...
class INTACT_OT_square_cut(bpy.types.Operator):
    """Square Cutting Tool add"""

    bl_idname = "intact.square_cut"
    bl_label = "Square Cut"
    bl_options = {"REGISTER", "UNDO"}
    ...
    def invoke(self, context, event):
        ...
        if bpy.context.selected_objects == []:
            ...
            if context.space_data.type == "VIEW_3D":
                ...
                CuttingTarget = context.scene.INTACT_Props.CuttingTargetNameProp
...
class INTACT_OT_square_cut_confirm(bpy.types.Operator):
    """confirm Square Cut operation"""

    bl_idname = "intact.square_cut_confirm"
    bl_label = "Tirm"
    bl_options = {"REGISTER", "UNDO"}
    ...
    def execute(self, context):
        ...
        if bpy.context.selected_objects == []:
            ...
            try:
                cutting_mode = context.scene.INTACT_Props.cutting_mode
...
class INTACT_OT_square_cut_exit(bpy.types.Operator):
    """Square Cutting Tool Exit"""

    bl_idname = "intact.square_cut_exit"
    bl_label = "Exit"
    bl_options = {"REGISTER", "UNDO"}
...
class INTACT_OT_PaintArea(bpy.types.Operator):
    """ Vertex paint area context toggle """

    bl_idname = "intact.paintarea_toggle"
    bl_label = "PAINT AREA"
    bl_options = {"REGISTER", "UNDO"}
    ...
    def execute(self, context):
        ...
        if not ActiveObj:
            ...
            if not condition:
                ...
                ActiveObj.data.vertex_colors.new(name="INTACT_PaintCutter_VC")

                return {"FINISHED"}


class INTACT_OT_PaintAreaPlus(bpy.types.Operator):
    """ Vertex paint area Paint Plus toggle """

    bl_idname = "intact.paintarea_plus"
    bl_label = "PLUS"
    bl_options = {"REGISTER", "UNDO"}
...
class INTACT_OT_PaintAreaMinus(bpy.types.Operator):
    """ Vertex paint area Paint Minus toggle """

    bl_idname = "intact.paintarea_minus"
    bl_label = "MINUS"
    bl_options = {"REGISTER", "UNDO"}
...
class INTACT_OT_PaintCut(bpy.types.Operator):
    """ Vertex paint Cut """

    bl_idname = "intact.paint_cut"
    bl_label = "CUT"
    ...
    def execute(self, context):
        ...
        bpy.ops.ed.undo_push(message="INTACT Paint Cutter")
    ...
    #             self.INTACT_PaintCutter_VC = self.ActiveObj.data.vertex_colors.new(name='INTACT_PaintCutter_VC')
    #             context.window_manager.modal_handler_add(self)
    #             return {"RUNNING_MODAL"}
...
classes = [
    INTACT_OT_JoinObjects,
    INTACT_OT_SeparateObjects,
    INTACT_OT_Parent,
    INTACT_OT_Unparent,
    INTACT_OT_align_to_front,
    INTACT_OT_to_center,
    INTACT_OT_center_cursor,
    INTACT_OT_OcclusalPlane,
    INTACT_OT_OcclusalPlaneInfo,
    INTACT_OT_decimate,
    INTACT_OT_clean_mesh,
    INTACT_OT_fill,
    INTACT_OT_retopo_smooth,
    INTACT_OT_VoxelRemesh,
    INTACT_OT_CurveCutterAdd,
    INTACT_OT_CurveCutterAdd2,
    INTACT_OT_CurveCutterCut,
    INTACT_OT_CurveCutter2_ShortPath,
    INTACT_OT_square_cut,
    INTACT_OT_square_cut_confirm,
    INTACT_OT_square_cut_exit,
    INTACT_OT_PaintArea,
    INTACT_OT_PaintAreaPlus,
    INTACT_OT_PaintAreaMinus,
    INTACT_OT_PaintCut,
]
